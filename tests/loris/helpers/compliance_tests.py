...
class TestCompliance(object):
    ...
    def test_server_compliance_2_if_everything(self, everything_enabled_json):
        compliance = Compliance(everything_enabled_json)
        assert compliance.server_compliance == 2
    ...
    def test_service_compliance_1(self, everything_but_sizeByConfinedWh_json):
        ...
        assert compliance.server_compliance == 1
    ...
    def test_additional_features_two_plus(self, level2_plus_json):
        ...
        extras = ('max', 'regionSquare', 'webp')
        assert compliance.server_compliance == 2
        assert compliance.additional_features == extras

    def test_additional_features_one_plus_png(self, level1_plus_png_json):
        extras = ('png',)
        compliance = Compliance(level1_plus_png_json)
        assert compliance.server_compliance == 1
        assert compliance.additional_features == extras
